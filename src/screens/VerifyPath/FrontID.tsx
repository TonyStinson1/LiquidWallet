    ...
    return (
        <View style={styles.container}>
            <View style={{ margin: 20, marginBottom: 0 }}>
                <Text style={styles.textStyle}>Scan your Front part of ID</Text>
            </View>
            ...
            >
                {imageUpload ?
                    <Image source={require('../../../assets/images/FronID.png')} style={styles.image} />
                    :
            ...
            {imageUpload &&
                <View style={styles.contain}>
                    <View style={styles.titleContainer}>
                        ...
                        <View>
                            <Text style={[styles.textStyle1, { fontWeight: '600' }]}>ID Card [Front].</Text>
                        </View>
                        <View style={styles.arrow}>
                        ...
                        imgError ?
                            ...
                            <View>
                                ...
                                <View style={{ alignSelf: 'center', margin: 20, marginBottom: 0 }}>
                                    <Pressable
                                        style={styles.btn}
                                        onPress={() => navigation.navigate('BackID')}
                                        >
